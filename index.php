        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="index.php" class="active"> Indicadores </a>
              </li>
              <li>
		...
		<!-- ========== title-wrapper start ========== -->
          ...
          <!-- ========== title-wrapper end ========== -->
			...
			if ($con->connect_error) {
				...
				$query = 'SELECT count(*) AS servicios,SUM(if(pago=1,1,0)) AS pagados, SUM(if(pago=0,1,0)) AS pendientes,
						CONCAT("$",FORMAT(SUM(precio*unidades),2)) as bruto_total,
						CONCAT("$",FORMAT(((SUM(case when pago=1
							then
								precio*unidades 
							else 
								0 
							...
							IFNULL(
							(SELECT SUM(abono) FROM abonos WHERE folio IN(
									SELECT folio FROM servicios WHERE pago=0)
							),0))),2)) as bruto_pagado,
						CONCAT("$",FORMAT(((SUM(precio*unidades))-
							...
							(SELECT SUM(abono) FROM abonos WHERE folio IN(
									SELECT folio FROM servicios WHERE pago=0)
							),0))),2)) as bruto_pendiente,
						CONCAT("$",FORMAT(SUM((precio*unidades)*(comision/100)),2)) as comision_total,
						CONCAT("$",FORMAT(SUM(case when pago=1 
							then 
								(precio*unidades)*(comision/100) 
							else 
								0 
							end)+
							(IFNULL(
								(SELECT SUM(abono) FROM abonos WHERE folio IN(
										SELECT folio FROM servicios WHERE pago=0)
								),0)*(comision/100)),2)) as comision_pagado,
						CONCAT("$",FORMAT(SUM((precio*unidades)*(comision/100))-(SUM(case when pago=1 
							then 
								(precio*unidades)*(comision/100) 
							else 
								0 
							...
							(IFNULL(
								(SELECT SUM(abono) FROM abonos WHERE folio IN(
										SELECT folio FROM servicios WHERE pago=0)
								),0)*(comision/100))),2)) as comision_pendiente,
						CONCAT("$",FORMAT(SUM((precio*unidades)-((precio*unidades)*(comision/100))),2)) as neto_total,
						CONCAT("$",FORMAT((SUM(case when pago=1
							then
								precio*unidades 
							else 
							...
							(SELECT SUM(abono) FROM abonos WHERE folio IN(
								...
								SUM(case when pago=1 
									...
									(IFNULL(
										(SELECT SUM(abono) FROM abonos WHERE folio IN(
												SELECT folio FROM servicios WHERE pago=0)
										),0)*(comision/100))),2)) as neto_pagado,
						CONCAT("$",FORMAT(SUM((precio*unidades)-((precio*unidades)*(comision/100)))-((SUM(case when pago=1
							then
								precio*unidades 
							else 
								0 
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Servicios</h6>
                  <h3 class="text-bold mb-10"><?php echo $row['servicios']?></h3>
                  <p class="text-sm text-success">
                    <i class="lni lni-arrow-up"></i><?php echo $row['pagados']?> <span class="text-gray">Pagados</span>
				  </p>
				  <p class="text-sm text-danger">
                    <i class="lni lni-arrow-down"></i><?php echo $row['pendientes']?> <span class="text-gray">Pendientes</span>
                  </p>
                </div>
              </div>
              <!-- End Icon Cart -->
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Ingreso Bruto</h6>
                  <h3 class="text-bold mb-10"><?php echo $row['bruto_total']?></h3>
                  <p class="text-sm text-success">
                    <i class="lni lni-arrow-up"></i><?php echo $row['bruto_pagado']?> <span class="text-gray">Pagados</span>
				  </p>
				  <p class="text-sm text-danger">
                    <i class="lni lni-arrow-down"></i><?php echo $row['bruto_pendiente']?> <span class="text-gray">Pendientes</span>
                  </p>
                </div>
              </div>
              <!-- End Icon Cart -->
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Comisiones</h6>
                  <h3 class="text-bold mb-10"><?php echo $row['comision_total']?></h3>
                  <p class="text-sm text-success">
                    <i class="lni lni-arrow-up"></i><?php echo $row['comision_pagado']?> <span class="text-gray">Pagados</span>
				  </p>
				  <p class="text-sm text-danger">
                    <i class="lni lni-arrow-down"></i><?php echo $row['comision_pendiente']?> <span class="text-gray">Pendientes</span>
                  </p>				
                </div>
              </div>
              <!-- End Icon Cart -->
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  <h6 class="mb-10">Ingreso Neto</h6>
                  <h3 class="text-bold mb-10"><?php echo $row['neto_total']?></h3>
                  <p class="text-sm text-success">
                    <i class="lni lni-arrow-up"></i><?php echo $row['neto_pagado']?> <span class="text-gray">Pagados</span>
				  </p>
				  <p class="text-sm text-danger">
                    <i class="lni lni-arrow-down"></i><?php echo $row['neto_pendiente']?> <span class="text-gray">Pendientes</span>
                  </p>
                </div>
              </div>
              <!-- End Icon Cart -->
            ...
            <div class="row">
                ...
                <div class="invoice-card card-style mb-30">
					<div class="select-style-1">
						<input type="hidden" name="urll"  id="urll" value="inc/listar_cobros.php">
						<div id="loader"></div>
						<div class='ajax'></div>
					</div>
                </div>
