            ...
            <div class="col-lg-5 col-md-5 col-6">
              <div class="header-left d-flex align-items-center">
				...
				<div class="header-search d-none d-md-flex">
                  <form action="#">
                    <input type="text" placeholder="Buscar..." id="searchField2"/>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabelNC">Nuevo Servicio</h5>
	   ...
	   <form name="nuevo" id="nuevo">
		  <div class="modal-body">
			<div class="form-group">
				...
				<input type="text" name="folio" id="folio" placeholder="N° DE FOLIO" maxlength="30" class="form-control form-control-sm" style="text-transform:uppercase" required>			
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="select-position">
					...
					<?php
					$query = "SELECT unidad FROM unidades order by unidad";
					$result = $con->query($query);
					while($row = mysqli_fetch_assoc($result)){
						$unidad=$row['unidad'];
			...
			<div class="form-group">
				...
				<div class="select-position">
					<select name="conductor" id="conductor" class="form-select form-select-sm">
					<?php
					$query = "SELECT nombre FROM conductores order by nombre";
					$result = $con->query($query);
					while($row = mysqli_fetch_assoc($result)){
						$nombre=$row['nombre'];
			...
			<div class="form-group">
				<label for="comision">Unidades</label>
				<input type="number" name="unidades" id="unidades" placeholder=" " maxlength="2" class="form-control form-control-sm" required>			
			</div>			
			<div class="form-group">
				<label for="precio">Precio</label>
				<input type="number" step="any" name="precio" id="precio" placeholder="$" maxlength="10" class="form-control form-control-sm" required>			
			</div>
			<div class="form-group">
				<label for="comision">Comisión</label>
				<input type="number" step="any" name="comision" id="comision" placeholder="%" maxlength="2" class="form-control form-control-sm">			
			</div>
			<div class="form-group form-switch toggle-switch">
				<input type="checkbox" name="pago" id="pago" value="1" class="form-check-input">
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn light-btn btn-sm" onclick="limpiar('servicios')">Limpiar</button>
			<button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cerrar</button>
			<input type="submit" class="main-btn primary-btn btn-hover btn-sm" id="guardar" value="Agregar">
		  </div>
	   </form>
    </div>
  </div>
...
<!-- Comision -->
<div class="modal fade" id="ComisionM" tabindex="-1" aria-labelledby="ModalLabelA" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabelA">Comisión</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
	   <form name="fcomision" id="fcomision">
		  <div class="modal-body">
			<div class="form-group">
				<label for="foliocomision">Folio</label>
				<input type="text" name="foliocomision" id="foliocomision" placeholder="N° DE FOLIO" maxlength="30" class="form-control form-control-sm" style="text-transform:uppercase" required>		
			</div>
			<div class="form-group">
				<label for="comision">Comisión</label>
				<input type="number" step="any" name="comision" id="comision" placeholder="%" maxlength="2" class="form-control form-control-sm">			
			...
			<div class="form-group">
				<label>Notas</label>
				<textarea maxlength="400" name="notascomision"  id="notascomision" value="" class="form-control" placeholder="*Opcional"></textarea>
			</div>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn light-btn btn-sm" onclick="limpiar('comision')">Limpiar</button>
			<button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cerrar</button>
...
<!-- Termina Comision -->
<!-- Abono -->
<div class="modal fade" id="AbonoM" tabindex="-1" aria-labelledby="ModalLabelA" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabelA">Abono</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
	   <form name="abonar" id="abonar">
		  <div class="modal-body">
			<div class="form-group">
				<label for="folioabono">Folio</label>
				<input type="text" name="folioabono" id="folioabono" placeholder="N° DE FOLIO" maxlength="30" class="form-control form-control-sm" style="text-transform:uppercase" required>		
			</div>
			<div class="form-group">
				<label for="abono">Abono</label>
				<input type="number" step="any" name="abono" id="abono" placeholder="$" maxlength="10" class="form-control form-control-sm" required>			
			</div>
			<div class="form-group">
				<label for="fechaabono">Fecha</label>
				<input type="date" name="fechaabono" id="fechaabono" class="form-control form-control-sm" required>		
			</div>		
			<div class="form-group">
				<label>Notas</label>
				<textarea maxlength="400" name="notasabono"  id="notasabono" value="" class="form-control" placeholder="*Opcional"></textarea>
			</div>
		  </div>
		  <div class="modal-footer">
			<input type="hidden" name="urll"  id="urll" value="inc/listar_servicios.php">
			<button type="button" class="btn light-btn btn-sm" onclick="limpiar('abonos')">Limpiar</button>
			<button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cerrar</button>
			<input type="submit" class="main-btn primary-btn btn-hover btn-sm" id="guardar" value="Abonar">
		  </div>
	   </form>
    </div>
  </div>
