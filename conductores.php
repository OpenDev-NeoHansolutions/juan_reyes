  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabelNC">Nuevo Conductor</h5>
	   ...
	   <form name="nuevo" id="nuevo">
		  <div class="modal-body">
			<div class="form-group">
				<label>Nombre</label>
				<input type="text" maxlength="300" name="nombre"  id="nombre" value="" class="form-control" placeholder="Nombre del Conductor" required>
			</div>
			<div class="form-group">
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn light-btn btn-sm" onclick="limpiar('conductores')">Limpiar</button>
...
<!-- Contenedor -->
<input type="hidden" name="urlg"  id="urlg" value="inc/guardar_conductor.php">
<input type="hidden" name="urll"  id="urll" value="inc/listar_conductores.php">
<input type="hidden" name="urle"  id="urle" value="inc/eliminar_conductor.php">
