              ...
              <div class="col-md-6">
                <div class="title d-flex align-items-center flex-wrap mb-30">
                  ...
                  <a class="main-btn primary-btn btn-hover btn-sm" data-bs-toggle="modal" data-bs-target="#ModalN">
                    <i class="lni lni-plus mr-5"></i> Nuevo Cliente
				  </a>
                </div>
              </div>
              <!-- end col -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabelNC">Nuevo Cliente</h5>
	   ...
	   <form name="nuevo" id="nuevo">
		  <div class="modal-body">
			<div class="form-group">
				<label>Cliente</label>
				<input type="text" maxlength="300" name="cliente"  id="cliente" value="" class="form-control" placeholder="Nombre del Cliente" required>
			</div>
			<div class="form-group">
				<label>Razon Social</label>
				<input type="text" maxlength="300" name="raz_social"  id="raz_social" value="" class="form-control" placeholder="*Opcional">
			</div>
			<div class="form-group">
				<label>Actividad</label>
				<input type="text" maxlength="300" name="actividad"  id="actividad" value="" class="form-control" placeholder="*Opcional">
			</div>
			<div class="form-group">
				<label>Dirección</label>
				<input type="text" maxlength="400" name="direccion"  id="direccion" value="" class="form-control" placeholder="*Opcional">
			</div>
			<div class="form-group">
				<label>Contacto</label>
				<input type="text" maxlength="300" name="contacto"  id="contacto" value="" class="form-control" placeholder="*Opcional">
			</div>
			<div class="form-group">
				<label>Telefono</label>
				<input type="text" maxlength="100" name="telefono"  id="telefono" value="" class="form-control" placeholder="*Opcional">
			</div>			
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn light-btn btn-sm" onclick="limpiar('clientes')">Limpiar</button>
            ...
            <div class="row">
              <div class="col-12">
                <div class="invoice-card card-style mb-30">
					<!-- Contenedor -->
					<input type="hidden" name="urlg"  id="urlg" value="inc/guardar_cliente.php">
					<input type="hidden" name="urll"  id="urll" value="inc/listar_clientes.php">
					<input type="hidden" name="urle"  id="urle" value="inc/eliminar_cliente.php">
